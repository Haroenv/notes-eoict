...
; 	PIC18F4550. Het is speciaal uitgepast om gebruik te kunnen maken van de
...
; subroutines voeg je onderuit toe
; macro's bovenuit
...
; HOOFDPROGRAMMA
; ===============
	clrf TRISD	;gebruik led/lcd

lus:
	bsf LATD,0 ;led 0 uit
	call Delay
	bcf LATD,0 ;led 0 aan
	bsf LATD,1 ;led 1 uit
	call Delay
	bcf LATD,1 ;led 1 aan
	bsf LATD,2 ;led 2 uit
	call Delay
	bcf LATD,2 ;led 2 aan
	bsf LATD,3 ;led 3 uit
	call Delay
	bcf LATD,3 ;led 3 aan
	bsf LATD,2 ;led 2 uit
	call Delay
	bcf LATD,2 ;led 2 aan
	bsf LATD,1 ;led 1 uit
